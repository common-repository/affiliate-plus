<?php  
/*
Plugin Name: Affiliate Plus
Plugin URI: http://blogio.net/blog/affiliate-plus/
Description: Affiliate Plus lets your registered users get credit for new users they recruit
Author: Nico
Version: 1.3.2
...
{
	add_submenu_page('options-general.php', 'Affiliate Plus Settings', 'Affiliate Plus', 9, 'affiplus_settings', 'affiplus_settings');
}
